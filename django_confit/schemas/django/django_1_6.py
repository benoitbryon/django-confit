"""Configuration schemas for Django 1.6 branch."""
...
if django.VERSION[0] is 1 and django.VERSION[1] is 6:
    class Django1_6ConfigurationSchema(colander.MappingSchema):
