"""Configuration schemas for Django 1.5 branch."""
...
if django.VERSION[0] is 1 and django.VERSION[1] is 5:
    class Django1_5ConfigurationSchema(colander.MappingSchema):
