"""Configuration schemas for Django 1.8 branch."""
...
if django.VERSION[0] is 1 and django.VERSION[1] is 8:
    class Django1_8_0ConfigurationSchema(colander.MappingSchema):
        """Configuration schema for Django 1.8."""
    ...
    class Django1_8_1ConfigurationSchema(Django1_8_0ConfigurationSchema):
        """Configuration schema for Django 1.8.1."""

    class Django1_8_2ConfigurationSchema(Django1_8_1ConfigurationSchema):
        """Configuration schema for Django 1.8.2."""

    class Django1_8_3ConfigurationSchema(Django1_8_2ConfigurationSchema):
        """Configuration schema for Django 1.8.3."""

    class Django1_8_4ConfigurationSchema(Django1_8_3ConfigurationSchema):
        """Configuration schema for Django 1.8.4."""

    class Django1_8_5ConfigurationSchema(Django1_8_4ConfigurationSchema):
        """Configuration schema for Django 1.8.5."""

    class Django1_8_6ConfigurationSchema(Django1_8_5ConfigurationSchema):
        """Configuration schema for Django 1.8.6."""

    class Django1_8_7ConfigurationSchema(Django1_8_6ConfigurationSchema):
        """Configuration schema for Django 1.8.7."""
