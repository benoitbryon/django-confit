...
Please use `django-confit bugtracker`_ **before** starting some work:
...
* Release `django-confit` project with `zest.releaser`_: ``make release``.
...
.. _`django-confit bugtracker`: https://github.com/benoitbryon/django-confit/issues
